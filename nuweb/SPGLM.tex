...
\mbox{}\verb@    res <- list(coefficients = betas, f0=referencef0, mu0=mu0, niter = iter, loglik=mod$llik,@\\
...
\mbox{}\verb@    llik_term <- rowSums(t(th$fTilt) * hp)@\\
...
\NWtarget{nuweb5b}{} $\langle\,${\itshape M-step}\nobreak\ {\footnotesize {5b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@                  @\\
\mbox{}\verb@  fTiltMatrix <- mod$fTiltMatrix@\\
