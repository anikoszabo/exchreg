...
\mbox{}\verb@#' @{\tt @}\verb@importFrom stats terms model.matrix binomial dbinom glm uniroot@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@    if (is.null(weights))       @\\
\mbox{}\verb@      pooled <- CorrBin::CBData(data.frame(Trt = "All", NResp = Y[,1], ClusterSize = rowSums(Y)), trt="Trt",@\\
